pub mod urlparser {
    ...
    pub fn parse(input: String) -> Result<ParseValue, String> {
        ...
        Ok(ParseValue { converted_url, id })
    }
...
mod tests {
    ...
    fn test_parse_ok() {
        ...
        assert_eq!(
            converted_url,
            "https://img.2game.info/re_archive/l/rimworld/files/up_japanese/232912679/1214.zip"
        );
    }
